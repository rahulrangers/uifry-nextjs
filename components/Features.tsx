  ...
  return (
    <div>
      <div className="md2:grid grid-cols-2 w-screen flex flex-wrap-reverse justify-center">
        <div
          className="md2:mx-16  md:flex md:justify-center md2:w-[450px] w-[350px]"
          style={{
        ...
        <div className=" flex flex-col flex-wrap md2:items-start items-center  md2:m-5 md2:ml-20 m-10">
