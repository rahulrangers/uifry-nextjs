...
return(
    <div className="font-style hover:cursor-pointer ">
      <div className='m-5 sm:hidden flex justify-start'>
        ...
        <div className=" m-5  text-[26px] flex-wrap justify-center hidden sm:flex">
        <div className=" flex flex-col text-[15px]">
        <div className="flex">
        <img
                className="my-9 w-10 h-10"
                src={"https://iili.io/Jb1Dle4.png"}
                alt="logo"/>
          <div className="m-9 ml-0  text-[26px]  font-extrabold "> uifry</div>
          </div>
          <div className="m-2"> Help@Frybix.Com</div>
          <div className="m-2">+1234 567889</div>
          </div>
  ...
  return (
    <div>
      ...
      <Accordion defaultExpanded>
        ...
        <AccordionDetails>
         Contact Us for any help consectetur adipiscing elit. Suspendisse
