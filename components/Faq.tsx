  ...
  const Faq = ({ faqItems }: FaqProps) => {
    return(
        <div className="font-style ">
            ...
            <div className="flex">
            <div className="flex flex-wrap text-[36px] w-[500px] md:ml-32 md:justify-start justify-center ml-20 font-extrabold">Frequently Asked Questions</div>
        ...
        <div className="md:m-20 lg2:mr-5 m-10">
            <div className="font-style text-white  lg2:text-5xl md2:text-4xl sm:text-2xl py-5 flex justify-center sm:justify-start">ReadyToGetStarted?</div>
            <div className="font-style text-white flex justify-center sm:justify-start">Risus habitant leo egestas mauris diam eget morbi tempus vulputate.Risus habitant leo egestas mauris diam eget morbi tempus vulputate</div>
            <div className="flex justify-center md:justify-start">
            <button className="bg-white rounded-md px-6 py-3 my-4 hover:cursor-pointer hover:bg-slate-200">Download App</button>
           
            </div>
            <div className="  mt-5">
              <img className="rotate-45 lg2:w-[54px] w-[44px] filter invert mx-20" src="https://iili.io/JbE3pDu.png" alt="Secondary Hero Logo" />
            </div>
        </div>
