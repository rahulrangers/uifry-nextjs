...
const Navlinks = () => {
  return (
    <>
      ...
      <div className="m-5 mb-0 text-[26px] font-bold hover:text-orange-500"> Features</div>
    </>
  );
};
...
export default function Navbar() {
  ...
  return (
    <div>
      <div className="font-style m-5 flex md2:justify-start ">
        <div className="flex">
          <img
            ...
            alt="logo"
          />
          <div className="md2:mt-5 mx-2 my-5 md2:mr-14 md2:ml-1 text-[26px] font-extrabold">uifry™</div>
        </div>
        <div className="md2:flex justify-between w-screen ">
          ...
          <div className="flex justify-end md2:inline">
            ...
            <button onClick={toggleNavbar}>
              {!isOpen ? (
                ...
                <IoCloseSharp className="flex justify-end w-[50px] h-[50px] md2:hidden my-5" />
              )}
            </button>
          </div>
