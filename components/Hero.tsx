          ...
          <div className="flex flex-col md2:items-start items-center">
            ...
            >
              ...
              <div className="flex md2:justify-start justify-center items-center  w-full m-3">
                  <a href={ctaButtons[0].link} className="md2:text-[20px] text-[15px] bg-black text-white px-5 py-2 rounded-md hover:bg-slate-800 hover:text-white">
                    {ctaButtons[0].text}
                  </a>
            ...
            <div className="flex  mt-5">
              <img className="rotate-45 lg2:w-[54px] w-[44px]  mx-7" src="https://iili.io/JbE3pDu.png" alt="Secondary Hero Logo" />
            </div>
