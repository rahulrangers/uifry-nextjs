  ...
  return (
    <div className="font-style  ">
      <div className="flex justify-end m-5">
        <img className=" rotate-45 lg2:w-[64px] w-[44px]  mx-7 " src="https://iili.io/JbE3pDu.png" />
      </div>
      ...
      <div className=" md2:grid mb-20 grid-cols-2  flex flex-wrap justify-center">
        <div className=" ">
          <div
            className="md2:mx-24 w-30 md2:w-[400px] w-[350px] md2:mr-5"
            style={{
        ...
        <div className="m-5 flex flex-col justify-end flex-wrap ">
          ...
          <div className="flex flex-col md2:items-start items-center justify-center">
            <img className="h-[50px] w-[260px] my-5 " src="https://iili.io/JmuJYva.png" alt="avatars" />
