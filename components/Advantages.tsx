...
return(
    <div>
    <div className="md2:grid grid-cols-2 flex flex-wrap justify-center w-screen ">
  ...
  <div className=" text-black font-extrabold text-[36px] my-2"> {subheading}</div>
  <div className="flex ">
    <img className ="text-[24px] w-[30px] h-[30px] my-2" src="https://iili.io/JmfOrqN.png"/>
    <div className="my-2 ml-2 font-extrabold text-[20px]">{advantage[0].title}</div>
  </div>
...
<img  className=" rotate-45  w-[44px]  mx-7 " src="https://iili.io/JbE3pDu.png"></img>
</div>
    </div>
        </div>
...
<img  className=" rotate-45  w-[44px]  mx-7 " src="https://iili.io/JbE3pDu.png"></img>
        ...
        <div className="md2:mx-20 mx-10 md2:w-[450px] w-[350px] " style={{
    ...
    <div className=" flex flex-col mt-20  mx-20 md2:items-start items-center">
  <div className="flex " >
  ...
  <img  className=" rotate-12 w-[44px] m-7 " src="https://iili.io/JbE3pDu.png"></img>
  </div >
    <div>
     </div>
      </div>
